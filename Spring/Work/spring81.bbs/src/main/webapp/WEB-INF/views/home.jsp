...
public class RestController {
    ...
    public @ResponseBody ModelUser login(@RequestParam("id") String id, @RequestParam("pw") String pw) {
        ...
        <li>댓글용 rest 서비스 만들기
            <ol>
            <li><a href="/board/articleview/free/1"   target="_blank">/board/articleview/free/1  (GET)</a></li>
                <li>/restservice/getcomment     만들기(POST) </li>
                <li>/restservice/getcommentlist 만들기(POST) </li>
                <li>/restservice/insertcomment  만들기(POST) </li>
                <li>/restservice/updatecomment  만들기(POST) </li>
                <li>/restservice/deletecomment  만들기(POST) </li>
            </ol>
        </li>
    </ol>  
