...
public class ModelAttachFile {
    ...
    public String toString() {
        return "ModelAttachFile [attachfileno=" + attachfileno + ", filenameorig=" + filenameorig + ", filenametemp="
                + filenametemp + ", filetype=" + filetype + ", filesize=" + filesize + ", articleno=" + articleno
                + ", UseYN=" + UseYN + ", InsertUID=" + InsertUID + ", InsertDT=" + InsertDT + ", UpdateUID="
