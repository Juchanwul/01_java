...
public class WebConstants {
    ...
    public static final String NOT_LOGIN      = "로그인이되지 않았읍니다";
    public static final String ERROR_PASSWORD = "패스워드가 틀립니다";
    ...
    public static final String MSG_FAIL_DELETE_ARTICLE = "게시글 삭제 실패";
