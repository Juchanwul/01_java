...
<body>  
    ...
    <a href="spring/querystring?name=test&price=1244" target="_blank">spring/querystring?name=test&price=1244</a> <br />
    <a href="spring/querystring2?name=qna&price=200" target="_blank">spring/querystring2?name=qna&price=200</a> <br />
